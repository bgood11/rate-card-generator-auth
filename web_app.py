...
# Hardcoded password
REQUIRED_PASSWORD = "Sh3rminRat3Ch3ck"
...
def login():
    if request.method == 'POST':
        ...
        if password == REQUIRED_PASSWORD:
            ...
            return render_login_page(error="Incorrect password. Please try again.")
...
def render_login_page(error=None):
    ...
    <body>
        ...
        <div class="beta-notice">
            <strong>Beta Access Required</strong><br>
            This is a beta tool for internal use only. Please enter the access password to continue.
        </div>
